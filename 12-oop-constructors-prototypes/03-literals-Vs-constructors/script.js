...
// Even though the strLit  variables is a string literal for a prmitive typeof, it can still use the toUpperCase() method because the string literal is converted to a string object behind the scenes. This is called boxing.
